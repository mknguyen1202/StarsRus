...
public class DBTables {
    ...
    public static class TABLE_USER_WATCH_LIST {
        public static final String TABLENAME = "UserWatchList";   
    }

    public static class TABLE_USER_STOCK_LIST {
        public static final String TABLENAME = "UserStockList";   
    }

    public static class TABLE_BUY_STOCK {
        public static final String TABLENAME = "BuyStock";   
    }

    public static class TABLE_SELL_STOCK {
        public static final String TABLENAME = "SellStock";   
    }
    ...
    public static class TABLE_WALLET_TRANSACTION {
        public static final String TABLENAME = "WalletTransaction";   
    }

    public static class TABLE_ROLES {
    ...
    public static class TABLE_USER_ROLE {
        ...
        public static final String ATTR_USER_ID = TABLE_USER.ATTR_ID;
        public static final String ATTR_USERNAME = TABLE_USER.ATTR_USERNAME;
        public static final String ATTR_ROLE_ID = TABLE_ROLES.ATTR_ROLE_ID;
