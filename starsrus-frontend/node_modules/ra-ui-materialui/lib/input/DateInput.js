...
var DateInput = function (_a) {
    ...
    var sanitizedDefaultValue = defaultValue
        ? format(new Date(defaultValue))
        : undefined;
    var sanitizedInitialValue = initialValue
        ? format(new Date(initialValue))
        : undefined;
    var _e = ra_core_1.useInput(__assign({ defaultValue: sanitizedDefaultValue, format: format, formatOnBlur: true, initialValue: sanitizedInitialValue, name: name,
        onBlur: onBlur,
        onChange: onChange,
        onFocus: onFocus,
        parse: parse,
